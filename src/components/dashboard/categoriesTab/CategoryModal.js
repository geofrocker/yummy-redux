...
const CategoryModal = (props) => {
  const {modalTitle, catData, handleChange, addCategory, handleCategoryUpdate, handleClose} = props;
  return (
    <Modal show={props.show} onHide={props.handleClose}>
      ...
      <Modal.Body>
        <form onSubmit={modalTitle === 'Add Category' ? addCategory : handleCategoryUpdate} id="category-form">
          ...
          <Button onClick={handleClose} className="btn btn-success">Cancel</Button>
        </form>
      </Modal.Body>
    </Modal>
  );
